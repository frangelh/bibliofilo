<html>
    <head>
        <title>bibliofilo.do - Recomendaciones de libros al instante.</title>
        <meta charset="UTF-8">
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">bibliofilo.do</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="MostrarCarroCompra.jsp"><span class="glyphicon glyphicon-book"></span> Libros</a></li>
                            <li class="dropdown">
